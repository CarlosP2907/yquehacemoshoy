...
@section('page-title', 'Crear Nuevo Lugar')
@section('page-subtitle', 'Agrega un nuevo lugar donde ofreces tus servicios')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('company.places.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3" 
                                  placeholder="Describe tu lugar, servicios que ofreces, horarios, etc.">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input day-checkbox" 
                                                               ...
                                                               value="1"
                                                               data-day="{{ $dayKey }}"
                                                               {{ old("schedules.{$dayKey}.is_closed") ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input day-checkbox" 
                                                               ...
                                                               value="1"
                                                               data-day="{{ $dayKey }}"
                                                               {{ old("schedules.{$dayKey}.is_24_hours") ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <input type="time" 
                                                           ...
                                                           id="open_{{ $dayKey }}"
                                                           data-day="{{ $dayKey }}"
                                                           value="{{ old("schedules.{$dayKey}.open_time") }}"
                                                ...
                                                <div class="col-md-3">
                                                    <input type="time" 
                                                           ...
                                                           id="close_{{ $dayKey }}"
                                                           data-day="{{ $dayKey }}"
                                                           value="{{ old("schedules.{$dayKey}.close_time") }}"
                                                           placeholder="Cierre">
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-12">
                                                    <input type="text" 
                                                           ...
                                                           value="{{ old("schedules.{$dayKey}.special_note") }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const firstDayCard = document.querySelector('.row').children[0];
    firstDayCard.insertAdjacentHTML('beforebegin', addCopyButtonsHTML);
